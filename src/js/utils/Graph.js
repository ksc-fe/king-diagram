...
const {
    mxGraph, mxConstants, mxUtils, 
    mxGuide, mxCell, mxGeometry,
    mxText, mxGraphModel, mxGraphView,
    mxClient, mxSvgCanvas2D, mxShape,
    mxRectangle, mxPoint, mxCellHighlight,
    mxImage, mxCellRenderer, mxConnector,
    mxStencil, mxStencilRegistry, mxLayoutManager,
    mxEvent,
} = mx();
...
export {Graph as mxGraph, mxCell, mxGeometry};
